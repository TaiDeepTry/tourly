...
<?php foreach ($destinations as $index => $destination) { ?>
  <li <?php if ($index >= $displayLimit) { echo 'style="display: none;"'; } ?>>
    <div class="popular-card">
      <figure class="card-img">
        <img src="<?php echo $destination['link']; ?>" alt="<?php echo $destination['destination'] . ', ' . $destination['country']; ?>" loading="lazy">
      </figure>
      <div class="card-content">
        ...
        <h3 class="h3 card-title">
          <a href="#"><?php echo $destination['destination']; ?></a>
        </h3>
        <p class="card-text">
